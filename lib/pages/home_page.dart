...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _checkCurrentLocation() async {
    try {
      ...
      final detectedRoom = locationService.detectRoom(position.latitude, position.longitude, rooms);
              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Waktu Sekarang', style: TextStyle(fontSize: 16, color: Colors.grey)),
                      const SizedBox(height: 8),
                      Text(
                        _currentTime.isEmpty
                            ? 'Loading...'
                            : '${DateFormat('EEEE, dd MMMM yyyy', 'id_ID').format(DateTime.now())} • $_currentTime',
                        style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF2E4B9C)),
                      ),
                    ],
                  ),
                ),
              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Lokasi Terdeteksi', style: TextStyle(fontSize: 16, color: Colors.grey)),
                      const SizedBox(height: 8),
                      Text(
